...
import { Check, KeyRound, Settings2, Sparkles } from 'lucide-react';
...
const MODES: LlmMode[] = ['atoms', 'openai', 'mock'];

/**
 * 右上角设置入口。
 * atoms 模式从平台白名单里选模型；openai 模式可一键套用常见兼容端点（DeepSeek / Kimi / 通义等），
 * 也可以手填任意 Base URL 与模型名。
 */
